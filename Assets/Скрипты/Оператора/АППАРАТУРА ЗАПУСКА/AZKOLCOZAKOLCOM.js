...
function Update()
{
    transform.position = Vector3.Lerp(transform.position, target.TransformPoint(0, height, -distance), Time.deltaTime/10); //tween (lerp) between two points with time and damping
    //Ограничения
