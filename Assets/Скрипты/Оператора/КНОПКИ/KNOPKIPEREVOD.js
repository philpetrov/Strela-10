...
function OnMouseUp (){
    ...
    if (pedal == true) 
    {
        ...
        //uchebni.GetComponent(Renderer).material.color = Color(.100, .112, .800, .255); // Изменить цвет транспаранта Учебный
    ...
    if (OSVESHENIEstatic == true && OSVESHENIE == true) { //Если нажали в первый раз освещение и 24 ВКЛ
        ...
        OSVESHENIEstaticVKLUCHEN = true; //для обращения в др. скрипт, если включен тумблер то....
    }
