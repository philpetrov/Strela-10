...
function OnGUI() {
    ...
    if (GUI.Button (Rect (Screen.width/2-90,Screen.height/2+50,180,30), "ВЫХОД")) { 
        Application.Quit();
    }
    if (GUI.Button (Rect (Screen.width/2-90,Screen.height/2,180,30), "ПОВТОРИТЬ")) { 
        Application.LoadLevel (Application.loadedLevel); 
    }
    if (GUI.Button (Rect (Screen.width/2-90,Screen.height/2-50,180,30), "ГЛАВНОЕ МЕНЮ")) { 
